...
- 현재가·호가·캔들·가격제한폭·투자경고·거래 캘린더와 KRX 시장별 투자자 매매대금만 조회
...
| `INSTITUTIONAL_NET_BUY_SURGE` | KOSPI·KOSDAQ 기관 순매수가 최근 중앙값 배수와 최소 금액을 동시에 초과 |
| `INSTITUTIONAL_NET_SELL_SURGE` | KOSPI·KOSDAQ 기관 순매도가 최근 중앙값 배수와 최소 금액을 동시에 초과 |
